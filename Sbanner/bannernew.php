...
$kolor =  ImageColorAllocate($img, 0, 0, 0);
$border = imagecolorallocate($image, 0, 0, 255);

imagettftext($img, 20, 0, 190, 230, $kolor, $patch. $font, $news );

imagettftext($img, 19, 0, 20, 680, $kolor, $patch. $font, $welcome );
imagettftext($img, 19, 0, 80, 680, $color, $patch. $font, $nickname[$found]);
...
imagettftext($img, 19, 0, 650, 680, $kolor, $patch. $font, $countrytxt);
imagettftext($img, 19, 0, 730, 680, $color, $patch. $font, $country[$found]);

imagettftext($img, 19, 0, 400, 680, $kolor, $patch. $font, $elgw);
imagettftext($img, 19, 0, 495, 680, $color, $patch. $font, ''.$temp_max.'°C');
